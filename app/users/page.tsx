...
const users: User[] = [
  { id: "1", name: "Sarah Johnson", email: "sarah.johnson@example.com", role: "Admin", dateJoined: "2023-12-01", initials: "SJ" },
  { id: "2", name: "Alex Chen", email: "alex.chen@example.com", role: "Member", dateJoined: "2024-01-05", initials: "AC" },
  { id: "3", name: "Marcus Williams", email: "marcus.williams@example.com", role: "Member", dateJoined: "2024-01-10", initials: "MW" },
  { id: "4", name: "Emily Rodriguez", email: "emily.rodriguez@example.com", role: "Viewer", dateJoined: "2024-01-12", initials: "ER" },
  { id: "5", name: "James Park", email: "james.park@example.com", role: "Member", dateJoined: "2024-01-15", initials: "JP" },
];

function getRoleColor(role: User["role"]): "default" | "secondary" | "outline" {
  switch (role) {
    case "Admin":
      return "default";
    case "Member":
